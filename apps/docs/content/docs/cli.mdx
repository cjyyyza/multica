...
| `yixiezuo` | `preview` / `import` / `bridge` | Read one issue, import it explicitly, or run the local bridge for user-requested previews and result publication. | `<issue-url>`, `import --confirm --project-id`, `bridge --once` |
