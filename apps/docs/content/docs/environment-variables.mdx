...
| POPO | `MULTICA_POPO_SECRET_KEY` | Base64-encoded 32-byte key for optional loopback webhook tokens; the API never calls dj01bot |
...
For setup steps, see [GitHub integration](/github-integration#self-hosting-setup), [Lark bot](/lark-bot-integration#self-hosting-setup), [Slack bot](/slack-bot-integration#self-hosting-setup), [Telegram bot](/telegram-bot-integration#self-hosting-setup), and [POPO bot](/popo-bot-integration#self-hosting-setup).
